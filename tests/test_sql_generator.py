...
class SQL_TEST(unittest.TestCase):
    ...
    def setUpClass(SQL_TEST):
        SQL_TEST.sql = s.SQL(204, 'accounting_period',
    ...
    def test_insert_attrs_b_define_clause(self):
        self.assertEqual('SET DEFINE OFF;\n', SQL_TEST.sql.insert_attrs_b[
                         SQL_TEST.define_clause])
    ...
    def test_insert_attrs_b_values(self):
        self.assertEqual("values ( 204,'accounting_period','mdex:string',1,'2.3','MSI','N','N','N','N','N','N','N',0,0,SYSDATE,0,SYSDATE,0,null,null,null,null,null,null);",
                         SQL_TEST.sql.insert_attrs_b[SQL_TEST.attrs_b_values])

    def test_insert_attrs_tl_column_headers(self):
        insert_statement = SQL_TEST.sql.insert_attrs_tl(
            SQL_TEST.instance_id, 'accounting_period', 'D', 'Accounting Period', 'FND_EID_PDR_ATTRS_TL')
    ...
    def test_insert_attrs_tl_values(self):
        ...
        self.assertEqual("values ( 204,'accounting_period','D','US','Accounting Period','Accounting Period','Accounting Period','Accounting Period',0,SYSDATE,0,SYSDATE,0);",
                         insert_statement[SQL_TEST.attrs_tl_values])
    ...
    def test_insert_attrs_groups_set_define_clause(self):
        self.assertEqual('SET DEFINE OFF;\n', SQL_TEST.sql.insert_attr_groups[
                         SQL_TEST.define_clause])
    ...
    def test_insert_attrs_group_column_headers(self):
        self.assertEqual('Insert into APPS.FND_EID_ATTR_GROUPS (EID_INSTANCE_ID,EID_INSTANCE_GROUP,EID_INSTANCE_ATTRIBUTE,EID_INSTANCE_GROUP_ATTR_SEQ,EID_INST_GROUP_ATTR_USER_SEQ,GROUP_ATTRIBUTE_SOURCE,EID_RELEASE_VERSION,OBSOLETED_FLAG,OBSOLETED_EID_RELEASE_VERSION,CREATED_BY,CREATION_DATE,LAST_UPDATED_BY,LAST_UPDATE_DATE,LAST_UPDATE_LOGIN)',
                         SQL_TEST.sql.insert_attr_groups[SQL_TEST.attr_groups_insert])
    ...
    def test_insert_attrs_group_values(self):
        self.assertEqual("values ( 204,'Categories','accounting_period',1,1,'MSI','2.3','N',0,0,SYSDATE,0,SYSDATE,0);",
                         SQL_TEST.sql.insert_attr_groups[SQL_TEST.attr_groups_values])
    ...
    def test_update_attr_groups(self):
        self.assertEqual("SET EID_INSTANCE_GROUP_ATTR_SEQ = 1, EID_INST_GROUP_ATTR_USER_SEQ = 1 WHERE EID_INSTANCE_ID = 204 AND EID_INSTANCE_ATTRIBUTE = 'accounting_period';",
                         SQL_TEST.sql.update_attr_groups[SQL_TEST.update_attr_groups_set])
    ...
    def test_create_insert_statement(self):
        ...
        self.assertEqual('Insert into APPS.FND_EID_PDR_ATTRS_B (EID_INSTANCE_ID,EID_INSTANCE_ATTRIBUTE,ENDECA_DATATYPE)\n',
                         SQL_TEST.sql.create_insert_statement(s.SQL.ATTRS_B, column_headers))

    def test_concat_schema_table(self):
        self.assertEqual('APPS.FND_EID_ATTRS_B', SQL_TEST.sql.concat_schema_table(
    ...
    def test_create_values_string(self):
        ...
        self.assertEqual("values ( 204,'accounting_period','mdex:string',4);",
                         SQL_TEST.sql.create_values_string(*values))
