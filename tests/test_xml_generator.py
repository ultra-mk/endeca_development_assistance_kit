...
class XML_TEST(unittest.TestCase):
    ...
    def setUpClass(XML_TEST):
        XML_TEST.field_list = [['currency_code', 'mdex:string'], [
            'organization_id', 'mdex:string']]
    ...
    def test_single_field(self):
        self.assertEqual('<Field name="po_header_id" type="string"/>',
                         XML_TEST.xml.single_field('po_header_id', 'mdex:string'))

    def test_all_fields(self):
        self.assertEqual('<Field name="currency_code" type="string"/>\n<Field name="organization_id" type="string"/>',
                         XML_TEST.xml.all_fields(XML_TEST.field_list))
