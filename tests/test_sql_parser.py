...
class SQL_PARSER_TEST(unittest.TestCase):
    ...
    def test_format_column_aliases(self):
        self.assertEqual(['RCTA.CUSTOMER_TRX_ID', 'PURCHASE_ORDER', 'dt_revenue', 'SALES_ORDER', 'Wwapc', 'SALES_OFFICE',
                          'PART_NUMBER'], SQL_PARSER_TEST.instance.format_column_aliases(SQL_PARSER_TEST.column_headers))
