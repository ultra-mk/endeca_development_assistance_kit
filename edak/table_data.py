...
GROUPS_TL = {'name': 'FND_EID_GROUPS_TL','columns': ['EID_INSTANCE_ID','EID_INSTANCE_GROUP','LANGUAGE','SOURCE_LANG','DISPLAY_NAME','GROUP_DESC',
                                                    'USER_DISPLAY_NAME','USER_GROUP_DESC','CREATED_BY','CREATION_DATE','LAST_UPDATED_BY',
