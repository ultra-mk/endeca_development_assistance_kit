...
#need to add an attribute source as a parameter
    ...
    def insert_attrs_tl(self, eid_instance_id ,eid_instance_attribute, language_code, display_name):
    	insert_statement = 'Insert into '+ SQL.SCHEMA +'.FND_EID_PDR_ATTRS_TL (EID_INSTANCE_ID,EID_INSTANCE_ATTRIBUTE,LANGUAGE,SOURCE_LANG,DISPLAY_NAME,ATTRIBUTE_DESC,USER_DISPLAY_NAME,USER_ATTRIBUTE_DESC,CREATED_BY,CREATION_DATE,LAST_UPDATED_BY,LAST_UPDATE_DATE,LAST_UPDATE_LOGIN) values'
...
#this method could use some TLC.
    def insert_attrs_tl_all(self, eid_instance_id, eid_instance_attribute, display_name):
        ...
        rem_insert_statement = 'REM INSERTING into '+ SQL.SCHEMA +'.FND_EID_PDR_ATTRS_TL\n'
