...
class EEE_SQL_TEST(unittest.TestCase):
	...
	def setUpClass(EEE_SQL_TEST):
		EEE_SQL_TEST.insert_attr = e.Insert_attribute(204,'accounting_period', 'mdex:string', 1)
		EEE_SQL_TEST.define_clause = slice(0,16)
		EEE_SQL_TEST.rem_insert = slice(16, 60)
		EEE_SQL_TEST.insert = slice(60,632)
		EEE_SQL_TEST.values = slice(632,770)
	...
	def test_init_Insert_attribute(self):
		...
		self.assertEqual('1', EEE_SQL_TEST.insert_attr.profile_id)
		

	def test_init_Insert_sql(self):
		...
		self.assertEqual("(204,'accounting_period','mdex:string',1,'2.3','MSI','N','N','N','N','N','N','N','0',0,SYSDATE,0,SYSDATE,0,null,null,null,null,null,null);", EEE_SQL_TEST.insert_attr.sql[EEE_SQL_TEST.values])
